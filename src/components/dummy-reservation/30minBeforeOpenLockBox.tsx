    ...
    <div className="ml-4 w-full">
      <div className="w-full rounded-[16px] flex h-28 bg-primary">
        <div className="w-[40%] rounded-[16px] overflow-hidden">
          <Image
            src="/CardsImages/30minBeforeOpenLockBox.png"
            alt="Image"
        ...
        <div className="w-[45%] flex flex-col items-start p-0">
          <div className="flex flex-col w-full justify-center my-auto">
            <p className="m-0 p-0 text-[20px] text-white">Your LockBox Key will be available in</p>
            <p className="m-0 p-0 text-[36px] font-bold text-white">25 Min : 38 Sec</p>
          </div>
        </div>
...
export default BeforeOpenLockBox;
