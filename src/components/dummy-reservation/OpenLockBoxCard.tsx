    ...
    <div className="ml-4 w-full">
      <div className="w-full rounded-[16px] flex h-28 bg-primary">
        <div className="w-[40%] rounded-[16px] overflow-hidden">
          <Image src="/CardsImages/OpenLockBox.png" alt="Image" className="w-full h-full object-cover" layout="responsive" width={300} height={200} />
        </div>
        <div className="w-[45%] flex flex-col items-start p-0 ">
          <div className="flex flex-col justify-center my-auto w-full">
            <p className="m-0 p-0 text-[24px] text-white ">Your LockBox Key is now available!</p>
            <button className="items-start py-2 bg-white text-primary rounded-full border-none max-w-[170px] mt-1">Open LockBox</button>
          </div>
        </div>
