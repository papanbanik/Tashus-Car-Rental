...
const DLFrontPhoto: React.FC<IFileUploadProps> = ({
  limit,
  multiple,
  name,
  control,
  ...
  useEffect(() => {
    if (userProfileInfo?.guestVerification?.drivingLicensePhoto?.imageInfo?.secure_url) {
      setSelectedProfileImage(userProfileInfo?.guestVerification?.drivingLicensePhoto?.imageInfo?.secure_url);
    }
      ...
      <div className="md:w-1/2 w-full">
        <div className="w-full relative h-48">
          <Image
            ...
            src="/Images/Guest-Verification/tashus-dl-front.png"
        ...
        <p className="text-center mt-2">Sample Front Photo</p>
      </div>
      ...
      <div className="md:w-1/2 w-full">
        {selectedProfileImage ? (
          <div className="flex flex-col justify-center items-center w-full">
            ...
            {/* <Button variant="contained" color="success" className="md:mt-6 mt-10" type="submit" disabled={!isValid || isLoading || isSuccess}>
