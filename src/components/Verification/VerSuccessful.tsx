  ...
  return (
    <Box className="w-full flex flex-col items-center justify-center">
      ...
      <Typography variant="h1" className="text-lg md:text-xl lg:text-3xl font-bold py-4">
        Verification Successful. Welcome to
        <span className="text-primary"> TASHUS</span>
      </Typography>
      <Typography variant="body1" className="text-gray-600 py-4 text-justify">
        {`Your email has been verified. Get started the journey with us. You'll be able to book or list vehicle instantly if you`}{' '}
      ...
      {/* <Link className="no-underline" href="/car-listing"> */}
      {/* <Button
