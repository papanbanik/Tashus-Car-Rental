...
import SingleTravelData from './SingleTravelData';
...
const TravelData: React.FC<TravelDataProps> = ({ travelType, dataList }) => {
            ...
            <div key={index}>
              ...
              <div className="grid grid-cols-1 gap-4 my-8">
                {group?.groupDataList.map((travel: TSingleTravel) => (
                  <SingleTravelData key={travel?.reservationId} travel={travel} showDetails={showDetails}></SingleTravelData>
                ))}
              </div>
            </div>
          ))}
