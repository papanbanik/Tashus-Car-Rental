...
const TravelDurationInfo = ({ hideText }: ITravelDurationInfo) => {
  const { updatedTravelData } = useTravelContext();

  return (
    <>
      <ShowPickupReturnTime
        startDate={updatedTravelData?.pickupDate}
        endDate={updatedTravelData?.returnDate}
        hideText={hideText}
      ></ShowPickupReturnTime>
...
export default TravelDurationInfo;
